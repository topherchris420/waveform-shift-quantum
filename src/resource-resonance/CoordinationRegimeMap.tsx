...
export const CoordinationRegimeMap = ({ params }: { params: SimulationParams }) => {
  ...
  return <section className="rounded-xl border border-slate-800 bg-slate-900/40 p-5">
    ...
    <p className="mt-2 text-[11px] text-slate-500">Scenario grid: financial stress → (x), routing-data reliability ↑ (y). Each cell reports the strongest modeled net outcome; uncertainty can produce no winner.</p>
